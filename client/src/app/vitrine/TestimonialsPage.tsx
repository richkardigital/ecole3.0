...
const TESTIMONIALS = [
  {
    ...
    type: 'DIRECTEUR',
    content: 'Avant ÉCOLE 3.0, la période des conseils de classe et l\'impression des bulletins était un vrai cauchemar. Désormais, tout le calcul de moyennes et le rang des 1 200 apprenants se font automatiquement en 1-clic.',
    rating: 5,
  ...
  },
  {
    ...
    type: 'ENSEIGNANT',
    content: 'La saisie des notes et le partage de supports de cours par chapitre ont révolutionné ma pratique. Les apprenants reçoivent leurs devoirs directement sur l\'application.',
    rating: 5,
