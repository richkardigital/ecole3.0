...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const base = 'inline-flex items-center justify-center font-bold rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white focus-visible:ring-[#189CD8] disabled:opacity-40 disabled:cursor-not-allowed select-none transition-all duration-200 active:scale-[0.97]';

  const variants = {
    primary: 'bg-[#189CD8] text-white hover:bg-[#1280B2] shadow-[0_4px_16px_rgba(24,156,216,0.3)] hover:shadow-[0_6px_20px_rgba(24,156,216,0.4)] hover:-translate-y-0.5',
    ...
    glow: 'bg-[#189CD8] text-white font-black shadow-[0_0_0_1px_rgba(24,156,216,0.4),0_4px_20px_rgba(24,156,216,0.35)] hover:shadow-[0_0_0_1px_rgba(24,156,216,0.6),0_8px_24px_rgba(24,156,216,0.45)] hover:-translate-y-0.5',
  };
