  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex items-center justify-between h-20" style={{ height: '5rem' }}>
            ...
            <div className="flex items-center gap-2 md:hidden">
              <button
                ...
                className="p-2 rounded-xl transition-all duration-200 text-slate-500 hover:text-slate-900"
        ...
        {isOpen && (
          <div
            className="md:hidden px-4 py-5 space-y-2 animate-fade-in-down"
          ...
          >
            ...
            <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
              ...
              <Link to="/inscription" className="w-full" onClick={() => setIsOpen(false)}>
